...
% Constructor
%==================================================================   
        function [obj] = StitchStandardPhaseCorr1a(Options)
            obj.Options = Options;
            obj.Log = Log('');
        end                
...
%==================================================================   
        function Initialize(obj)
            ...
            for AcqNum = 1:obj.NumAcqsPerReadout
                obj.Stitch{AcqNum}.PhaseCorrInitialize(obj.Log);
            end 
        end
