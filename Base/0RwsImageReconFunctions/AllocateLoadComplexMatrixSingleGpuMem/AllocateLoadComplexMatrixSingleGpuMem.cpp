...
Image = (float*)mxGetComplexSingles(prhs[1]);
...
// Allocate Memory                
//-------------------------------------
ArrAllocSglOneC(GpuNum,HImage,ArrLen,Error);
...
// Load Image            
//-------------------------------------
ArrLoadSglOneC(GpuNum,Image,HImage,ArrLen,Error);
if (strcmp(Error,"no error") != 0) {
	plhs[1] = mxCreateString(Error); return;
	}
