...
if (strcmp(Error,"no error") != 0) {
	plhs[3] = mxCreateString(Error); return;
	}
...
Tst_Dim[0] = 1; 
Tst_Dim[1] = 20; 
plhs[2] = mxCreateNumericArray(2,Tst_Dim,mxINT64_CLASS,mxREAL);
Tst = (mwSize*)mxGetData(plhs[2]);
...
// if (strcmp(Error,"no error") != 0) {
// 	plhs[3] = mxCreateString("CrtDatC"); return;
// 	}	
...
// if (strcmp(Error,"no error") != 0) {
// 	plhs[3] = mxCreateString("CrtDatCTemp"); return;
// 	}
...
// if (strcmp(Error,"no error") != 0) {
// 	plhs[3] = mxCreateString("Kx"); return;
// 	}
...
// if (strcmp(Error,"no error") != 0) {
// 	plhs[3] = mxCreateString("Ky"); return;
// 	}
...
// if (strcmp(Error,"no error") != 0) {
// 	plhs[3] = mxCreateString("Kz"); return;
// 	}
...
// if (strcmp(Error,"no error") != 0) {
// 	plhs[3] = mxCreateString("Kern"); return;
// 	}
