...
%================================================================== 
        function StitchPostAcqProcess(obj,ReconObj,DataObj,log)
            ...
            %DataBlockReorg(:,TrajMash.reorg_index,:)=DataObj.DataBlock;
            DataBlockReorg=DataObj.DataBlock;
            ...
            for m = 1:NumImages
                ...
                for p = 1:ReconObj.ReconGpuBatches
                    ...
                    for n = 1:ReconObj.ReconBlocksPerImage
                        ...
                        TempDataObj.DataBlock = DoTrajMash(DataBlockReorg,WeightArr(:,m),DataObj.NumAverages,TbStart,TbStop,TbSize,RbStart,RbStop,RbSize);
